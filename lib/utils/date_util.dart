...
class DateUtil {
  ...
  /// [duration] 待转换的时间戳
  ///
  static String friendlyDateTime2(int duration) {
    String friendly = '';
    String agoOrAfter = '以前';

    int now = DateTime.now().millisecondsSinceEpoch;

    if (now < duration) agoOrAfter = '以后';
    ...
    if (seconds < 60) {
      friendly = agoOrAfter == '以后' ? '马上' : '刚刚';
    } else if (seconds >= 60 && seconds < 60 * 60) {
      friendly = '$minutes分钟$agoOrAfter';
    } else if (seconds >= 60 * 60 && seconds < 60 * 60 * 24) {
      friendly = '$hours小时$agoOrAfter';
    } else if (seconds >= 60 * 60 * 24 && seconds < 60 * 60 * 24 * 2) {
      friendly = "${agoOrAfter == '以后' ? '明天' : '昨天'} ${getDateStrByMs(duration, format: DateFormat.HOUR_MINUTE)}";
    } else if (seconds >= 60 * 60 * 24 * 2 && seconds < 60 * 60 * 24 * 3) {
      friendly = "${agoOrAfter == '以后' ? '后天' : '前天'} ${getDateStrByMs(duration, format: DateFormat.HOUR_MINUTE)}";
    } else if (seconds >= 60 * 60 * 24 * 3 && seconds < 60 * 60 * 24 * 7) {
      friendly = '$days天$agoOrAfter';
    } else if (seconds >= 60 * 60 * 24 * 7 && seconds < 60 * 60 * 24 * 30) {
      friendly = '$weeks星期$agoOrAfter';
    } else if (seconds >= 60 * 60 * 24 * 30 && seconds < 60 * 60 * 24 * 30 * 6) {
      friendly = '$mounts个月$agoOrAfter';
    } else if (seconds >= 60 * 60 * 24 * 30 * 6 && seconds < 60 * 60 * 24 * 30 * 12) {
